...
#yellow
COLOR_LIGHTYELLOW = 0x0C
COLOR_YELLOW = 0x0D
COLOR_DARKYELLOW = 0x0E
COLOR_DARKERYELLOW = 0x0F 
...
#alt colors
COLOR_PUREORANGE = 0x3C
COLOR_YELLOWORANGE = 0x3D
COLOR_YELLOWGREEN = 0x3E
COLOR_APPLEGREEN = 0x3F
